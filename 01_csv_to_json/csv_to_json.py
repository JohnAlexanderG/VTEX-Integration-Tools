...
Script principal para convertir archivos CSV y XLS a formato JSON. Forma parte del flujo 
de transformación de datos para integración con VTEX e-commerce platform.

Funcionalidad:
- Lee archivos CSV y XLS con encabezados como primera línea
...
Dependencias:
- pandas: requerido para lectura de archivos .xls
...
def main():
    parser = argparse.ArgumentParser(
        description='Convierte archivos CSV y Excel (XLS/XLSX) a JSON.',
    ...
    parser.add_argument(
        ...
        nargs='?',
        default='-',
        help='Archivo de entrada CSV/XLS/XLSX (por defecto: stdin para CSV)'
    )
    parser.add_argument(
        'json_output',
        nargs='?',
